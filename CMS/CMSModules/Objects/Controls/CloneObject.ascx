...
<div class="form-horizontal">
    ...
    <div id="advancedItems" class="hidden">
        ...
        <asp:PlaceHolder runat="server" ID="plcCloneUnderSite" Visible="false">
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblCloneUnderSite" ResourceString="clonning.settings.cloneundersite" AssociatedControlID="siteElem"
                        EnableViewState="false" DisplayColon="true" />
                </div>
                <div class="editing-form-value-cell">

...
<div class="PageContent">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel AssociatedControlID="chkShowInNavigation" CssClass="control-label" runat="server" ID="lblShowInNavigation" ResourceString="om.showinnavigation"
                    DisplayColon="true" />
            </div>
            <div class="editing-form-value-cell">
                <cms:CMSCheckBox runat="server" ID="chkShowInNavigation" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel AssociatedControlID="chkShowInSiteMap" CssClass="control-label" runat="server" ID="lblShowInSiteMap" ResourceString="om.showinsitemap"
                    DisplayColon="true" />
            </div>
            <div class="editing-form-value-cell">
                <cms:CMSCheckBox runat="server" ID="chkShowInSiteMap" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">

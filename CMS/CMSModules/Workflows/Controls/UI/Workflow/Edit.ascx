        ...
        <asp:PlaceHolder runat="server" ID="plcAdvanced">
            <cms:FormCategory runat="server" ID="pnlAdvanced" CategoryTitleResourceString="general.advanced">
                ...
                <asp:PlaceHolder ID="plcAutomation" runat="server">
                    <cms:FormField runat="server" ID="wRecurrenceType" Field="WorkflowRecurrenceType" Layout="Inline">
                        <div class="form-group">
                            <div class="editing-form-label-cell">
                                <cms:FormLabel CssClass="control-label" ID="lblRecurrenceType" runat="server" EnableViewState="false" ResourceString="cms.workflow.recurrency"
                                    DisplayColon="true" />
                            </div>
                            <div class="editing-form-value-cell">
                                <cms:FormControl ID="ucRecType" runat="server" FormControlName="AutomationRecurrenceType" />
                            </div>
                        </div>
                    </cms:FormField>
                </asp:PlaceHolder>

<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_PortalEngine_Controls_WebParts_WebPartPropertiesFieldEditor"  CodeFile="WebPartPropertiesFieldEditor.ascx.cs" %>

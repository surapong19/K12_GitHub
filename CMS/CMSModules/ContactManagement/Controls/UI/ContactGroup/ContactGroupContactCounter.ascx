<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="ContactGroupContactCounter.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_ContactGroup_ContactGroupContactCounter" %>

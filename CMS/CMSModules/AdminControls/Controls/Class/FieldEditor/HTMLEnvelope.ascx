<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="HTMLEnvelope.ascx.cs"
    ...
    <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="editing-form-value-cell">
                <cms:EditingFormControl ID="txtContentBefore" runat="server" AllowMacroEditing="true" FormControlName="LargeTextArea" IsLiveSite="false" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
            ...
            <div class="editing-form-value-cell">
                <cms:EditingFormControl ID="txtContentAfter" runat="server" AllowMacroEditing="true" FormControlName="LargeTextArea" IsLiveSite="false" />
            </div>
        </div>
    </div>
</asp:Panel>
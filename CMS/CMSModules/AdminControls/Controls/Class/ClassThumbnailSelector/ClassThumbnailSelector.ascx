<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="ClassThumbnailSelector.ascx.cs" Inherits="CMSModules_AdminControls_Controls_Class_ClassThumbnailSelector_ClassThumbnailSelector" %>

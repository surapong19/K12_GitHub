<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="ClassThumbnailSelectorFormControl.ascx.cs" Inherits="CMSModules_AdminControls_Controls_Class_ClassThumbnailSelector_ClassThumbnailSelectorFormControl" %>

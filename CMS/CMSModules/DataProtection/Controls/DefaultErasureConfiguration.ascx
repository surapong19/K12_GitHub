<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultErasureConfiguration.ascx.cs" Inherits="CMSModules_DataProtection_Controls_DefaultErasureConfiguration" %>

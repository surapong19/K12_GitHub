                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblSkuEditAction" Visible="<%#IsLiveSite%>" runat="server" Text='<%#GetSKUEditAction(Eval("SKUID"), Eval("SKUSiteID"), Eval("SKUParentSKUID"), Eval("IsProductOption"))%>'
                                        CssClass="EditOrderItemLink" EnableViewState="false" />
                                    <asp:Label ID="lblEditAdminButtons" Visible="<%#!IsLiveSite%>" Text='<%#GetOrderItemEditAction(Eval("CartItemGuid")) + GetSKUEditAction(Eval("SKUID"), Eval("SKUSiteID"), Eval("SKUParentSKUID"), Eval("IsProductOption")) %>' runat="server" EnableViewState="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%-- Product name field --%>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <%#GetSKUName(Eval("SKUID"), Eval("SKUName"), Eval("IsProductOption"), Eval("CartItemText"))%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%-- Units field --%>
                            <asp:TemplateField>
                    ...
                    <cms:BasicRepeater runat="server" ID="rptrCouponCodes">
                        <ItemTemplate>
                            <div class="cart-coupon-code">
                                ...
                                <div class="button">
                                    <%# EcommerceTransformationFunctions.GetDiscountCouponCodeRemoveButton(Eval<string>("Code")) %>
                                </div>
                            </div>
                        </ItemTemplate>
                    </cms:BasicRepeater>

<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="ProductSectionsContextMenu.ascx.cs"
...
<cms:ContextMenu runat="server" ID="menuElem" DocumentTypeWhere="ClassIsProductSection = 1 OR ClassIsProduct = 1"
     DocumentTypeOrderBy="MenuItemOrder, ClassIsProductSection DESC, ClassDisplayName"
    HidePropertiesItem="true" ShowSectionProperties="true" EnableABTestVariant="false" ResourceName="" />

<%@ Page Title="Post detail" Language="C#" MasterPageFile="~/CMSMasterPages/UI/Dialogs/ModalDialogPage.master" AutoEventWireup="true" Inherits="CMSModules_SocialMarketing_Pages_FacebookPostDetailDialog"  CodeFile="FacebookPostDetailDialog.aspx.cs" Theme="Default" %>

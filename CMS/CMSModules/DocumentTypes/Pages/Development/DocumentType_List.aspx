...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:UniGrid runat="server" ID="uniGrid" ShortID="g" OrderBy="ClassDisplayName" IsLiveSite="false" ObjectType="cms.documenttype" Columns="ClassID, ClassDisplayName, ClassName, ClassIsCoupledClass, ClassIsContentOnly">
        ...
        <GridColumns>
            ...
            <ug:Column Source="##ALL##" ExternalSourceName="DataType" Caption="$documenttype.type$" Wrap="false">
            </ug:Column>

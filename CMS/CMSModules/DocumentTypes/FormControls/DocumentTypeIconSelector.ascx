<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="DocumentTypeIconSelector.ascx.cs" Inherits="CMSModules_DocumentTypes_FormControls_DocumentTypeIconSelector" %>

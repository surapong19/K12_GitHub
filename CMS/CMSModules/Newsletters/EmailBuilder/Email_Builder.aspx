<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_Newsletters_EmailBuilder_Email_Builder" Theme="Default"
    CodeFile="Email_Builder.aspx.cs" MasterPageFile="~/CMSMasterPages/UI/EmptyPage.master" %>
...
<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    <div class="email-builder">
        ...
        <div class="email-builder-content">
            ...
            <iframe id="builderIframe" runat="server" name="builderIframe" clientidmode="Static" />
        </div>
    </div>

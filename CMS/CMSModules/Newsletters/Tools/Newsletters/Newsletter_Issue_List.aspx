...
<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    ...
    <cms:UniGrid runat="server" ID="UniGrid" ShortID="g" IsLiveSite="false" OrderBy="IssueStatus, CASE WHEN IssueMailoutTime IS NULL THEN 0 ELSE 1 END, IssueMailoutTime DESC"
        ObjectType="newsletter.issue" Columns="IssueID, IssueDisplayName, IssueMailoutTime, IssueSentEmails, IssueOpenedEmails, IssueUnsubscribed, IssueBounces, IssueIsABTest, IssueStatus, IssueVariantOfIssueID"
        ...
        <GridColumns>
            <ug:Column Source="##ALL##" ExternalSourceName="IssueDisplayName" Caption="$unigrid.newsletter_issue.columns.issuedisplayname$"
                Wrap="false">
            ...
            <ug:Column Source="##ALL##" ExternalSourceName="IssueOpenedEmails" Caption="$newsletters.issueopens$"
                Wrap="false" CssClass="TableCell" Name="openedemails" />
            <ug:Column Source="##ALL##" ExternalSourceName="IssueOpenedEmailsRate" Caption="$newsletters.issueopenrate$"
                Wrap="false" CssClass="TableCell" Name="openedemailsrate" />

            <ug:Column Source="##ALL##" ExternalSourceName="IssueClickedLinks" Caption="$newsletters.issueclicks$"
                Wrap="false" CssClass="TableCell" Name="issueclickedlinks" />
            <ug:Column Source="##ALL##" ExternalSourceName="IssueClickedLinksRate" Caption="$newsletters.issueclickrate$"
                Wrap="false" CssClass="TableCell" Name="issueclickedlinksrate" />

            <ug:Column Source="##ALL##" Caption="$newsletter.issue.unsubscriptions$"
                Wrap="false" CssClass="TableCell" ExternalSourceName="unsubscribtions" />

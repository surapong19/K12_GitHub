<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_ImportExport_Pages_ExportHistory_ExportHistory_Edit_History"
...
<asp:Content runat="server" ContentPlaceHolderID="plcControls">
    <cms:CMSUpdatePanel ID="pnlUpdateLink" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <cms:LocalizedButton ID="btnDeleteAll" runat="server" ResourceString="exporthistory.deleteallhistory"

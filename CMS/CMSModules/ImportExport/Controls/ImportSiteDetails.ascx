<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_ImportExport_Controls_ImportSiteDetails"  CodeFile="ImportSiteDetails.ascx.cs" %>
            ...
            <div class="selector-subitem">
                ...
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        ...
                        <cms:LocalizedLabel CssClass="form-control-error" id="lblErrorSiteName" runat="server" Visible="False" EnableViewState="False" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">

            ...
            <asp:Panel ID="pnlPageContent" runat="server">
                ...
                <asp:Panel ID="pnlAccessPart" runat="server" CssClass="NodePermissions">
                    ...
                    <asp:Panel ID="pnlAccessBox" CssClass="form-horizontal" runat="server">
                        ...
                        <cms:UIPlaceHolder ID="pnlSSL" runat="server" ModuleName="CMS.Content" ElementName="Security.SSL">
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <cms:LocalizedLabel ID="lblReqSSL" runat="server" EnableViewState="false" ResourceString="Security.RequiresSSL" CssClass="control-label" />
                                </div>
                                <div class="editing-form-value-cell">
                                    <div class="radio-list-vertical">
                                        <cms:CMSRadioButton GroupName="reqSSL" ID="radYesSSL" runat="server" ResourceString="general.yes" />
                                        <cms:CMSRadioButton GroupName="reqSSL" ID="radNoSSL" runat="server" ResourceString="general.no" />
                                        <asp:PlaceHolder ID="plcSSLParent" runat="server">
                                            <cms:CMSRadioButton GroupName="reqSSL" ID="radParentSSL" runat="server" />
                                        </asp:PlaceHolder>
                                        <cms:CMSRadioButton GroupName="reqSSL" ID="radNeverSSL" runat="server" ResourceString="Security.Never" />
                                    </div>
                                </div>
                            </div>
                        </cms:UIPlaceHolder>

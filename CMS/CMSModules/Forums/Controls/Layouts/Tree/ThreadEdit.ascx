<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Forums_Controls_Layouts_Tree_ThreadEdit"  CodeFile="ThreadEdit.ascx.cs" %>
                                                ...
                                                <tr style="border: medium none;">
                                                    ...
                                                    <td style="border: medium none; width: 100%;" class="Content">
                                                        ...
                                                        <span class="PostSubject">
                                                            <asp:Literal runat="server" ID="ltrSubject" /></span> <div class="PostText">

<%@ Page Language="C#" AutoEventWireup="false" Inherits="CMSModules_System_Macros_System_MacroReport" Theme="Default" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="System - Macros" CodeFile="System_MacroReport.aspx.cs" %>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <cms:LocalizedLabel runat="server" ID="lblSignedBy" ResourceString="macros.signedby" EnableViewState="false" />
                            </th>
                            <th class="text-center wrap-normal">

...
<asp:Panel ID="pnlBody" runat="server" SkinID="Default">
    ...
    <cms:CMSUpdatePanel runat="server" ID="pnlUpdate" CatchErrors="true" EnableViewState="true">
        <ContentTemplate>
            ...
            <cms:LocalizedHeading runat="server" ID="headPageViews" Level="4" ResourceString="Administration-System.PageViews" EnableViewState="false" />
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="editing-form-value-cell editing-form-value-cell-offset">
                        <strong>
                ...
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblPages" runat="server" EnableViewState="false" AssociatedControlID="lblValuePages" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValuePages" runat="server" EnableViewState="false" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblGetFilePages" runat="server" EnableViewState="false" AssociatedControlID="lblValueGetFilePages" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValueGetFilePages" runat="server" EnableViewState="false" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblSystemPages" runat="server" EnableViewState="false" AssociatedControlID="lblValueSystemPages" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValueSystemPages" runat="server" EnableViewState="false" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblNonPages" runat="server" EnableViewState="false" AssociatedControlID="lblValueNonPages" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValueNonPages" runat="server" EnableViewState="false" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblPagesNotFound" runat="server" EnableViewState="false" AssociatedControlID="lblValuePagesNotFound" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValuePagesNotFound" runat="server" EnableViewState="false" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <asp:Label CssClass="control-label" ID="lblPending" runat="server" EnableViewState="false" AssociatedControlID="lblValuePending" />
                    </div>
                    <div class="editing-form-value-cell">
                        <asp:Label CssClass="form-control-text" ID="lblValuePending" runat="server" EnableViewState="false" />
                    </div>
                </div>
            </div>

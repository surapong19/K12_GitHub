<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSWebParts/DancingGoat.Samples/DancingGoatConsents.ascx.cs" Inherits="CMSWebParts_DancingGoat_Samples_DancingGoatConsents" %>

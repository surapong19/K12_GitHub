<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSWebParts/DancingGoat.Samples/DancingGoatSmartSearchAzure.ascx.cs" Inherits="CMSWebParts_DancingGoat_Samples_DancingGoatSmartSearchAzure" %>

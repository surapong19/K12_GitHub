<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="~/CMSWebParts/DeviceProfiles/SwitchDeviceDetection.ascx.cs" Inherits="CMSWebParts_DeviceProfiles_SwitchDeviceDetection" %>

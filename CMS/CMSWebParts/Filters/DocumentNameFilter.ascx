<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="~/CMSWebParts/Filters/DocumentNameFilter.ascx.cs"
...
<uc1:DocumentNameFilterControl ID="filterDocuments" runat="server" />
<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Ecommerce_Checkout_Forms_CustomerDetail"  CodeFile="~/CMSWebParts/Ecommerce/Checkout/Forms/CustomerDetail.ascx.cs" %>

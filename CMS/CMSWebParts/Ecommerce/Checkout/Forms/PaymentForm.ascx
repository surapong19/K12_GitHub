<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Ecommerce_Checkout_Forms_PaymentForm"  CodeFile="~/CMSWebParts/Ecommerce/Checkout/Forms/PaymentForm.ascx.cs" %>

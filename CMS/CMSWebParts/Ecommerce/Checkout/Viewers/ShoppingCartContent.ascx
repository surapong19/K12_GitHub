<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Ecommerce_Checkout_Viewers_ShoppingCartContent"  CodeFile="~/CMSWebParts/Ecommerce/Checkout/Viewers/ShoppingCartContent.ascx.cs" %>

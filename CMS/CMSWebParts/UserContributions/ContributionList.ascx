<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_UserContributions_ContributionList"  CodeFile="~/CMSWebParts/UserContributions/ContributionList.ascx.cs" %>

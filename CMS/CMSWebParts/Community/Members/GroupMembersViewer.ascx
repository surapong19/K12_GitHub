<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Community_Members_GroupMembersViewer"  CodeFile="~/CMSWebParts/Community/Members/GroupMembersViewer.ascx.cs" %>

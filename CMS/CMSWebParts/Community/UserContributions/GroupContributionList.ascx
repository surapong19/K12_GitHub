<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Community_UserContributions_GroupContributionList"  CodeFile="~/CMSWebParts/Community/UserContributions/GroupContributionList.ascx.cs" %>

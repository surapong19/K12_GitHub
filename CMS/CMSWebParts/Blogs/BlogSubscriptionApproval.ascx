<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="~/CMSWebparts/Blogs/BlogSubscriptionApproval.ascx.cs" Inherits="CMSWebParts_Blogs_BlogSubscriptionApproval" %>

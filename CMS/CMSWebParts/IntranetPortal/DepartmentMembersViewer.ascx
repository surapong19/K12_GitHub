<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_IntranetPortal_DepartmentMembersViewer"  CodeFile="~/CMSWebParts/IntranetPortal/DepartmentMembersViewer.ascx.cs" %>
